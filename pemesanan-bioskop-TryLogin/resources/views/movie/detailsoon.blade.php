    ...
    <footer class="mt-5">
      <nav class="navbar bg-cikling-dark-purple">
        <div class="d-flex justify-content-center w-100">
          <!-- Menggunakan flexbox untuk membuat teks berada di tengah -->
          <p
            style="font-size: 10px; font-family: ssans serif"
            class="text-white d-flex my-auto">
            &copy; Cikling. All right reserved
          </p>
        </div>
      </nav>
    </footer>
