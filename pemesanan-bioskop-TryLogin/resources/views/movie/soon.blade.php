...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="height: auto">
      ...
      <hr class="hr" />
      <p class="h4 mb-4 font-subtitle mt-3" id="playing-now">Coming Soon</p>

        @foreach ($movie as $group)
            <div class="d-flex justify-content-center">
            @foreach ($group as $film)
                <!-- Card -->
                <a style="text-decoration: none" href="/moviesoon/{{$film['id']}}" class="card-button">
                    <div
                    class="card custom-card border border-0"
                    style="width: 200px; height: 410px; margin-bottom: 0">
                    <img
